                                        ...
                                        <div class="container">
                                            <div class="row text-center text-lg-start">
                                                ...
                                                <div class="col-lg-3 col-md-4 col-6 mb-4">
                                                    <div class="card">
                                                        <img class="card-img-top" src="{{$scooter->moto_img}}" alt="{{$scooter->marque}} {{$scooter->modèle}}">
                                                        <div class="card-body">
                                                            <h5 class="card-title ">{{$scooter->marque}} {{$scooter->modèle}} {{$scooter->cylindrée}}cc</h5>
                                                            <a href="#" class="btn card_btn" data-toggle="modal" data-array='{"id_moto":"{{$scooter->id_moto}}","modèle":"{{$scooter->modèle}}","marque":"{{$scooter->marque}}"}' data-target="#reservationModal">Reserver</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endforeach
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal_reservation">
                ...
                <div class="modal-header page_title">
                    <div class="row">
                        <div class="col-12">
                            <h5 class="modal-title">Reserve your :</h5>
                        </div>
                        <div class="col-12">
                        ...
                        <form id="reservation-form">
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-md-12">
                                    ...
                                    <!-- <select name="id_moto" id="" class="input form-control" disabled>
                                        <option id="optionMoto" value=""></option>
                                    </select> -->
